...
class inode_state {
   ...
   public:
      ...
      void setCwd(inode_ptr new_cwd){cwd = new_cwd;}
      static string filepath;
      inode_ptr get_root(){return root;}
      inode_ptr get_cwd(){return cwd;}
      static map<string, inode_ptr> directories;
      static map<string, string> file_content;
      static map<string, inode_ptr> file_name;
};
...
class directory: public base_file {
   ...
   public:
      ...
      map<string, inode_ptr>& get_dir(){return dirents;}
};
